...
function centric_enqueue_home_scripts() {
	...
	wp_enqueue_script( 'localScroll', get_stylesheet_directory_uri() . '/js/jquery.localScroll.min.js', array( 'scrollTo' ), filemtime( get_stylesheet_directory() . '/js/jquery.localScroll.min.js'), true );
	wp_enqueue_script( 'scrollTo', get_stylesheet_directory_uri() . '/js/jquery.scrollTo.min.js', array( 'jquery' ), filemtime( get_stylesheet_directory() . '/js/jquery.scrollTo.min.js' ), true );
